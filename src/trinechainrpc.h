...
#ifndef _TRINECHAINRPC_H_
#define _TRINECHAINRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // TRINECHAIN is not connected
...
/**
 * TRINECHAIN RPC command dispatcher.
 */
class CRPCTable
{
private:

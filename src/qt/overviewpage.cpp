...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate(): QAbstractItemDelegate(), unit(TRINECHAINUnits::BTC)
    {
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = TRINECHAINUnits::formatWithUnit(unit, amount, true);
        if(!confirmed)
        {
...
//    ui->labelStake->setText(TRINECHAINUnits::formatWithUnit(unit, stake));
    ui->labelUnconfirmed->setText(TRINECHAINUnits::formatWithUnit(unit, unconfirmedBalance));
    ui->labelImmature->setText(TRINECHAINUnits::formatWithUnit(unit, immatureBalance));
